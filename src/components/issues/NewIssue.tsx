...
const NewIssue = () => {
  ...
  const availableUsers = repositoryUsers
    ? ([...repositoryUsers.members, repositoryUsers.lead].filter(
        Boolean
      ) as UserProfile[])
    : [];
  ...
  const filteredAssignees = useMemo(
    () =>
      availableUsers.filter((user) =>
        (user?.name ?? "")
          .toLowerCase()
          .includes(filters.assignees.toLowerCase())
      ),
  ...
  const handleInputChange = (
    field: keyof CreateIssueFormData,
    value: string
  ) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="p-2 space-y-6">
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      className={`bg-black border-slate-600 text-white placeholder:text-gray-400 text-lg py-3 px-4 focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200 ${
                        errors.title
                  ...
                  <div className="space-y-3">
                    ...
                    <div
                      className={`bg-black border rounded-lg border-slate-600 text-white placeholder:text-gray-400 text-lg py-3 px-4 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-400/20 transition-all duration-200 ${
                        errors.description
                ...
                <div className="flex items-center justify-between p-4  mt-auto">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button
                      ...
                      onClick={() => navigate(-1)}
                      disabled={isCreating}
                      className="border-slate-600 bg-black text-gray-300 hover:text-white hover:bg-slate-800"
                    >
                      Cancel
                    </Button>
                    <Button
            ...
            <div className="lg:col-span-1">
              <Card
                ref={sidebarRef}
                className="bg-grey border-0 backdrop-blur-sm rounded-xl shadow-lg"
              >
                <div className="p-2 space-y-2">
                  <SidebarDropdown
                    ...
                    currentValue={
                      repositories.find((r) => r.id === formData.repositoryId)
                    ...
                    <div className="absolute w-full mt-1 z-10 shadow-lg">
                      <div className="bg-black border border-slate-700 rounded-tl-lg rounded-tr-lg p-2 border-b-0">
                        <Input
                          ...
                          onChange={(e) =>
                            handleFilterChange("repository", e.target.value)
                          }
                          onClick={(e) => e.stopPropagation()}
                        ...
                        {filteredRepositories.length > 0 ? (
                          filteredRepositories.map((repo) => (
                            <div
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                selectDropdownItem("repositoryId", repo.id);
                              }}
                            >
                              {repo.name}
                            </div>
                          ...
                          filteredTags.map((tag) => (
                            ...
                            >
                              <input
                                ...
                                readOnly
                                checked={
                                  formData.tagIDs?.includes(tag.id) || false
                                }
                      ...
                      selectedAssignees.length > 0 ? (
                        ...
                        <span>
                          ...
                          <button
                            ...
                            aria-disabled={
                              !formData.repositoryId || !currentUser
                            }
                      ...
                      <div className="max-h-60 overflow-y-auto bg-black border border-slate-700 rounded-b-lg border-t-0">
                        {filteredAssignees.length > 0 ? (
                          filteredAssignees.map((user) => (
                            <div
                              key={user.id}
                              className="text-white text-xs flex items-center gap-3 p-2 border-b border-slate-800 last:border-b-0 hover:bg-slate-800 cursor-pointer"
                              onClick={(e) => {
                                e.stopPropagation();
                            ...
                            >
                              <input
                                ...
                                className="flex-shrink-0 h-4 w-4 bg-transparent border-slate-600 rounded"
                              />
                              <span>{user.name}</span>
                            </div>
                          ))
